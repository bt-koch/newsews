...
% We assume that the information in past articles is still relevant at time $t$, whereby the relevancy is decreasing over time. Hence, we construct the sentiment indicator $SI_{b,t}$ as a $N$-period backward-looking weighted moving average as follows:
% 
%\begin{equation} \label{eq:sentind}
