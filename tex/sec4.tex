...
Hier noch gemäss PQM Richtlinien: Ziel, Motivation (das habe ich ja eig. schon) und Aufbau des Kapitels (ein Satz je Abschnitt).
...
Hier die Methode für Topic Modelling beschreiben. Auch schreiben dass dies nicht mehr weiter in Analyse verfolgt wurde. ODer sollte ich dies noch machen? Je nach Zeit und Umfang... Eventuell dann auch nur für ein sample und ein Moedll -> für "champion modell"? Zuerst Fokus auf was ich schon habe...

\newpage

mit topic modelling werde ich diese seite noch erreichen
