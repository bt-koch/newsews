...
\begin{tikzpicture}[node distance=2cm]
    ...
    \node (preproc3) [block, below=0.25cm of preproc2, align=left] {\sout{paragraph 3}};
    \node (preproc4) [block, below=0.25cm of preproc3, align=left] {\sout{paragraph 4}};
    ...
    \node[below=1.375cm of classified3, align=center] {2) Estimation};
