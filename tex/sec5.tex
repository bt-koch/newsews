...
\begin{equation}
	cdsspread_{b,t} = \alpha_b + \sum_{k=1}^K\beta_{b,k}x_{b,k,t} + \theta_bs_{b,t} + \sum_{g=1}^G\gamma_gz_{g,t}+e_{b,t}
\end{equation}
...
\begin{equation}
	cdsspread_{b,t} = \alpha_b + \sum_{k=1}^K\beta_{b,k}x_{k,t-1} + \sum^5_{\tau=1} \delta_{b,\tau}Y_{b,t-\tau} + \sum^T_{\tau=1}\theta_{b,\tau}s_{b,t-\tau} + e_{b,t}
\end{equation}
